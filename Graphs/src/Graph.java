...
public class Graph {
        ...
        if (this.connected) {
            ...
            if (!this.edgeQ.isEmpty()) {
                do {
                    ...
                    if (sets(tmp.vertex1, tmp.vertex2, sets)) {
    ...
    private boolean sets(int vertex1, int vertex2, int[] continuity) {
        if (continuity[vertex1] != continuity[vertex2]) {
            int toBeReplaced;
            int ID;
            if (continuity[vertex1] == -1 || continuity[vertex2] == -1) {
                toBeReplaced = -1;
                if (continuity[vertex1] < 0) {
                    ID = continuity[vertex2];
                } else {
                    ID = continuity[vertex1];
                }
            } else if (continuity[vertex2] < continuity[vertex1]) {
                toBeReplaced = continuity[vertex1];
                ID = continuity[vertex2];
            } else {
                toBeReplaced = continuity[vertex2];
                ID = continuity[vertex1];
            }
            continuity[vertex1] = continuity[vertex2] = ID;
            if (toBeReplaced != -1) {
                for (int i = 0; i < continuity.length; i++) {
                    if (continuity[i] == toBeReplaced) {
                        continuity[i] = continuity[vertex1];
                    }
                }
            }
        } else if (continuity[vertex1] == continuity[vertex2] && continuity[vertex1] == -1) {
            if (vertex2 > vertex1) {
                continuity[vertex1] = continuity[vertex2] = vertex1;
            } else {
                continuity[vertex1] = continuity[vertex2] = vertex2;
            }
        } else if (continuity[vertex1] == continuity[vertex2]) {
            return false;
        }
        return true;
    }
